...
current status of the core hardware such as the CPU, GPU, PMIC, Power Supply, RP1 Chip, and NVMe SSD. For information on the RP1 chip, and
any connected NVMe SSD, additional packages are required. 
...
The script will also print the supply voltage which is just the external usb-c power supply voltage. 
...
```
==== System Status ====
Timestamp: Mon 24 Nov 22:05:04 CST 2025
Throttle status: Not Throttled
SOC Temp: 32.3°C
PMIC Temp: 31.2°C
CPU Clock: 2400 mHz
GPU Clock: 910 mHz
CPU Voltage: 0.89128130V
CPU Current: 0.74118990A
GPU Voltage: 0.8862V
Supply voltage: 5.10138000V
RP1 southbridge Temp: 40.9°C  
SSD0 /dev/nvme0n1 Temp1: 22°C
SSD0 /dev/nvme0n1 Temp2: 29°C
SSD1 /dev/nvme1n1 Temp1: 23°C
SSD1 /dev/nvme1n1 Temp2: 30°C
```
...
CPU Clock: 2400 mHz
GPU Clock: 910 mHz
CPU Voltage: 0.89154980V
CPU Current: 0.76798000A
GPU Voltage: 0.8862V
Supply voltage: 5.09602000V
RP1 southbridge Temp: 40.9°C  
SSD0 /dev/nvme0n1 Temp1: 22°C
SSD0 /dev/nvme0n1 Temp2: 29°C
SSD1 /dev/nvme1n1 Temp1: 23°C
